...
def main():
    ...
    f = open('training_data_correction_10_10_10_10.csv' , 'w')
    f.write('Ti,Te,X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14,X15,X16,X17,X18,X19,X20,X21,X22,X23,X24,X25,X26,X27,X28,X29,pressure_0,CCl4_X_0,t,tr,Schi_X,Choi_X,correction_factor\n')
    ...
    n = 1
    for mass_flow_rate in np.linspace(72, 44, 10):
        for pressure_0 in np.linspace(11, 13, 10):   
            for CCl4_X_0 in np.linspace(0, 0.0025, 10):
                for i in range(10):
                    ...
                    while not success:
                        ...
                        compositions, t, cracking_rates_Schi = EDC_cracking(
                                                    reaction_mech_x,
                                                    T_list,
                                                    pressure_0,
                                                    CCl4_X_0,
                        ...
                        _, _, cracking_rates_Choi = EDC_cracking(
                                                    reaction_mech_y,
                                                    T_list,
                                                    pressure_0,
                                                    CCl4_X_0,
                        ...
                        for j in range(n_pfr):
                            ...
                            information += str(cracking_rates_Schi[j+1]) + ',' + str(cracking_rates_Choi[j+1]) + ',' + f"{(cracking_rates_Choi[j+1]/cracking_rates_Schi[j+1])}" '\n'
