...
def main():
    ...
    f = open(f'Data/FPC_coking_V1/training_dataV1_{CCl4_X_0}_{CHCl3_X_0}_{Tri_X_0}_{CP_X_0}.csv' , 'a')
    if os.stat(f'Data/FPC_coking_V1/training_dataV1_{CCl4_X_0}_{CHCl3_X_0}_{Tri_X_0}_{CP_X_0}.csv').st_size ==0:
        f.write('Ti,Te,X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12,X13,X14,X15,X16,X17,X18,X19,X20,X21,X22,X23,X24,X25,X26,X27,X28,X29,pressure_0,CCl4,CHCl3,Tri,CP,t,tr,coking\n')
    T_list = []
    if T_in == 300:
    ...
    for j in range(n_pfr):
        ...
        information += str(pressure_0) + ',' + str(CCl4_X_0) + ',' + str(CHCl3_X_0) \
            + ',' + str(Tri_X_0) + ',' +str(CP_X_0) + ',' + str(sum(t[:j+1])) + ',' + str(t[j]) + ',' + "" +'\n'
