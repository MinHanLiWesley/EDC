...
def predict(reaction_mech, T_list, pressure_0, CCl4_X_0, mass_flow_rate,
            n_steps, n_pfr, length, area, save_fig=False, name='predict', fold_no=None, iter_CCl4=False, FPC=True,print_cracking=False,loss=False):
    """
...
if __name__ == '__main__':
    ...
    if DOKFOLD:
        ...
        if PREDICT:
            ...
            loss = predict(reaction_mech, T_list, pressure_0, CCl4_X_0, mass_flow_rate,
                           n_steps, n_pfr, length, area, save_fig=True, name=name,print_cracking= True)
