...
def build_model(lr=0.001):
    input = Input(shape=(35,),name='Input_layer_1')
    layer = Dense(15, name='Hinden_layer_1')(input)
    layer = Activation('relu')(layer)
    layer = Dense(28, name='Hinden_layer_2')(layer)
    layer = Activation('relu')(layer)
    layer = Dense(43, name='Hinden_layer_3')(layer)
    layer = Activation('relu')(layer)
    layer = Dense(40, name='Hinden_layer_4')(layer)
    layer = Activation('relu')(layer)
    layer = Dense(40, name='Hinden_layer_5')(layer)
    layer = Activation('relu')(layer)
